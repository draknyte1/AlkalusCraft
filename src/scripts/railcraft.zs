...
var ironTankBlock = <Railcraft:machine.beta>;
var steelTankBlock = <Railcraft:machine.beta:13>;
var ironTankValve = <Railcraft:machine.beta:2>;
var steelTankValve = <Railcraft:machine.beta:15>;
var leverMinecraft = <minecraft:lever>;
...
recipes.addShaped(cartTrackRemover, [
	...
	[<minecraft:sticky_piston>, <ore:blockSteel>, <minecraft:sticky_piston>],
	[<ore:craftingToolCrowbar>, <minecraft:minecart>, <ore:craftingToolCrowbar>]]);

recipes.addShaped(cartTrackRelayer, [
	[<ore:dyeYellow>, <minecraft:redstone_lamp>, <ore:dyeYellow>],
	[<ore:stickLongBronze>, <ore:blockSteel>, <ore:stickLongBronze>],
	[<ore:craftingToolCrowbar>, <minecraft:minecart>, <ore:craftingToolCrowbar>]]);
...
recipes.removeShaped(tankWallSteel, [
	...
	//Make Valves fix
recipes.addShapeless(ironTankValve, [ironTankBlock, leverMinecraft]);
recipes.addShapeless(steelTankValve, [steelTankBlock, leverMinecraft]);
...
Assembler.addRecipe(wireElectricShunting * 8, itemIngotLead * 4, paper * 4, moltenCopper * 1296, 200, 32);