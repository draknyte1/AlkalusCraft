...
var ingotElectricalSteel = <ore:plateElectricalSteel>;
var ingotElectricalSteel2 = <EnderIO:itemAlloy>;
...
var alloyVibrant = <ore:plateVibrantAlloy>;
...
BlastFurnace.addRecipe([ingotDarkSteel], [ingotElectricalSteel2, dustObsidian], 4000, 360, 2000);
