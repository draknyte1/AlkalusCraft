...
//Energy Buffers
val bufferCore = <miscutils:itemBufferCore>;
val buffer1 = <gregtech:gt.blockmachines:770>;
val buffer2 = <gregtech:gt.blockmachines:771>;
val buffer3 = <gregtech:gt.blockmachines:772>;
val buffer4 = <gregtech:gt.blockmachines:773>;
val buffer5 = <gregtech:gt.blockmachines:774>;
val buffer6 = <gregtech:gt.blockmachines:775>;
val buffer7 = <gregtech:gt.blockmachines:776>;
val buffer8 = <gregtech:gt.blockmachines:777>;
val buffer9 = <gregtech:gt.blockmachines:778>;
val buffer10 = <gregtech:gt.blockmachines:779>;

val wire1 = <gregtech:gt.blockmachines:1223>;
val wire2 = <gregtech:gt.blockmachines:1243>;
val wire3 = <gregtech:gt.blockmachines:1363>;
val wire4 = <gregtech:gt.blockmachines:1423>;
val wire5 = <gregtech:gt.blockmachines:1583>;
val wire6 = <gregtech:gt.blockmachines:1563>;
val wire7 = <gregtech:gt.blockmachines:1623>;
val wire8 = <gregtech:gt.blockmachines:1703>;
val wire9 = <gregtech:gt.blockmachines:2023>;
val wire10 = <gregtech:gt.blockmachines:2025>;

//Buffer Core
recipes.addShaped(bufferCore * 1, [
	[<gregtech:gt.metaitem.01:17058>, <IC2:itemPartCircuit>, <gregtech:gt.metaitem.01:17058>],
	[<gregtech:gt.metaitem.01:17058>, <GalacticraftCore:tile.aluminumWire:1>, <gregtech:gt.metaitem.01:17058>],
	[<gregtech:gt.metaitem.01:17058>, <IC2:itemPartCircuit>, <gregtech:gt.metaitem.01:17058>]]);
	
//Battery Buffer Tier - ULV
recipes.addShaped(buffer1 * 1, [
	[wire1, bufferCore, wire1],
	[wire1, elvTransformer, wire1],
	[null, null, null]]);	
//Battery Buffer Tier - LV
recipes.addShaped(buffer2 * 1, [
	[wire2, bufferCore, wire2],
	[wire2, lvTransformer, wire2],
	[null, null, null]]);	
//Battery Buffer Tier - mV
recipes.addShaped(buffer3 * 1, [
	[wire3, bufferCore, wire3],
	[wire3, mvTransformer, wire3],
	[null, null, null]]);	
//Battery Buffer Tier - HV
recipes.addShaped(buffer4 * 1, [
	[wire4, bufferCore, wire4],
	[wire4, hvTransformer, wire4],
	[null, null, null]]);	
//Battery Buffer Tier - EV
recipes.addShaped(buffer5 * 1, [
	[wire5, bufferCore, wire5],
	[wire5, evTransformer, wire5],
	[null, null, null]]);	
//Battery Buffer Tier - InV
recipes.addShaped(buffer6 * 1, [
	[wire6, bufferCore, wire6],
	[wire6, inTransformer, wire6],
	[null, null, null]]);
//Battery Buffer Tier - LuV
recipes.addShaped(buffer7 * 1, [
	[wire7, bufferCore, wire7],
	[wire7, luTransformer, wire7],
	[null, null, null]]);
//Battery Buffer Tier - ZPMV
recipes.addShaped(buffer8 * 1, [
	[wire8, bufferCore, wire8],
	[wire8, zpmTransformer, wire8],
	[null, null, null]]);
//Battery Buffer Tier - UltV
recipes.addShaped(buffer9 * 1, [
	[wire9, bufferCore, wire9],
	[wire9, ultTransformer, wire9],
	[null, null, null]]);
//Battery Buffer Tier - MaxV
recipes.addShaped(buffer10 * 1, [
	[wire10, bufferCore, wire10],
	[wire10, <gregtech:gt.blockcasings:9>, wire10],
	[null, null, null]]);
	
//IC2 Steam Conversion
val steamCan = <IC2:itemFluidCell>.withTag({Fluid: {Amount:1000, FluidName:"steam"}});
val steamCanIC2 = <IC2:itemFluidCell>.withTag({Fluid: {Amount:1000, FluidName:"ic2steam"}});

recipes.addShaped(steamCan * 1, [
	[steamCanIC2, null, null],
	[null, null, null],
	[null, null, null]]);	
recipes.addShaped(steamCanIC2 * 1, [
	[steamCan, null, null],
	[null, null, null],
	[null, null, null]]);
