...
var itemReactorPowerPort = <BigReactors:BRReactorPart:3>;

###############################

# Reactor Power Port
recipes.remove(itemReactorPowerPort);
recipes.addShaped(itemReactorPowerPort, [
	[itemReactorCasing, <ore:plateCyanite>, itemReactorCasing],
	[plateStainlessSteel, <ore:batteryElite>, plateStainlessSteel],
	[itemReactorCasing, <ore:plateCyanite>, itemReactorCasing]]);
