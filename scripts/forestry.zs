...
val plateElectrical = <ore:plateElectricalSteel>;
...
recipes.addShaped(engineElectrical, [
	[plateElectrical, plateElectrical, plateElectrical],
	[HHammer, blockGlass, wrench],
	[gearGtSmallSteel, piston, gearGtSmallSteel]]);
